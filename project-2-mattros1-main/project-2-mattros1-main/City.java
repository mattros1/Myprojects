...
public class City{
    ...
    public City(Random rand, int numMice, int numCats, int numZombieCats,int numPhoenix) {
        this.rand = rand;
        ...
        /* Populate mice */
        for (int i=0; i<numPhoenix; i++) addPhoenix();
    ...
    public void addPhoenix(){
        creaturesToAdd.add(new Phoenix(rand.nextInt(HEIGHT),rand.nextInt(WIDTH),this,rand));
    }
